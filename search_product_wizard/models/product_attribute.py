...
class ProductAttributeValue(models.Model):
        ...
        def name_search(self, name, args=None, operator='ilike', limit=100):
            ...
            if state:
                    ...
                    for value in attribute_vlaue:
                        ...
                        for attr_lst in attribute_list:
                            ...
                            for product in attr_lst.product_ids:
                                if bool(set(attr_list).intersection(product.attribute_value_ids.ids)):
                ...
                return super(ProductAttributeValue, self).name_search(name=name, args=args, operator=operator, limit=limit)
