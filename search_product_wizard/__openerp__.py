# -*- coding: utf-8 -*-
{
    ...
    'description': '''
                    ...
                    generating a Report based on the same.
                    Settings of the Product Attributes are being maintained
                    from Configurations.
                    A Package with the entered quantity of the relevant product
                    will be created and will generate a consequent Lot Number.
                ''',
    'depends': ['stock'],
    'data': [
